...
const Signboard2qrlm = (props) => {
    ...
    return (
        <div className='w-[611px] h-[458px] bg-[#f4f4f4]'>
            <div className='flex gap-8 items-center'>
                <div>
                    ...
                    <div className='flex mt-[2.3px] gap-[2px]'>
                        <div
                            className='w-[361px] bg-slate-100 h-[313px] mt-[5.6px] bg-cover bg-center bg-no-repeat relative'
                ...
                <div className='w-[181px]'>
                    ...
                    <div className='mt-[12.5px]'>
                        ...
                        <div className='font-lato mt-5 space-y-[5px] text-[#3a3a3a]'>
                    ...
                    <div className='font-lato text-[12.8px] mt-[14px] space-y-[4.18px] text-[#3a3a3a]'>
                        ...
                        <h1 className='font-lato text-[10px] text-[#3a3a3a] font-bold' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('website', e)}>{content.website}</h1>
                        <img src={Qr} className='w=[71px] py-1 mt-[17px]' alt="" />
                        <div className='flex items-center'>
                            <h1 className='text-[#3a3a3a] font-lato text-[7.8px]'>In Partnership with</h1>
                            <img src={Lm} className='w-[110px] h-[18px]' alt="" />
                        </div>
                    </div>
                </div>
            </div>
