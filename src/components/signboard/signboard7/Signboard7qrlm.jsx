    ...
    return (
        <div className='w-[226px] h-[452px] bg-[#fff] dark:bg-[#f4f4f4]'>
            ...
            <div className='flex gap-[2px]'>
                <div
                    className='w-full bg-slate-100 h-[72px] bg-cover bg-center bg-no-repeat relative'
            ...
            <div className='font-inter justify-end mt-[7px] px-2 text-[7px] flex gap-[2px] text-[#3a3a3a] font-bold'>
            ...
            <div className='border-b-2 border-[#8f8f8f] w-[209px] mx-auto flex justify-center mt-[3.7px]'></div>
            <div className='flex justify-between items-baseline'>
                <div className='mt-2 px-2'>
                    <ul className='list-disc space-y-[3px] text-[#3a3a3a] text-[6px] font-lato leading-[140%]'>
                    ...
                    <div className='font-lato mt-1 space-y-[1.2px] text-[#3a3a3a] text-[6px]'>
                    ...
                    <h1 className='font-lato text-[8px] mt-[7px] text-[#3a3a3a] font-bold leading-[140%]' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('website', e)}>{content.website}</h1>
                </div>
                <div className='font-lato pr-3 space-y-[2.18px] text-[#3a3a3a]'>
                    <h1 className='text-[4.8px] font-normal'>Agent Contact</h1>
                    <h1 className='text-[4.642px] font-bold' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('name', e)}>{content.name}</h1>
                    <div className='flex items-center gap-[3.6px]'>
                        <BiSolidPhoneCall className='w-[8px] h-[7.2px]' />
                        <p className='text-[4.5px] font-inter' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('phone', e)}>{content.phone}</p>
                    </div>
                    <div className='flex items-center gap-[3.6px]'>
                        <RiWhatsappFill className='w-[8px] h-[7.2px]' />
                        <p className='text-[4.5px] font-inter' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('wa', e)}>{content.wa}</p>
                    </div>
                    <div className='flex items-center gap-[3.6px]'>
                        <IoMdMail className='w-[8px] h-[7.2px]' />
                        <p className='text-[4.5px] font-inter' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('email', e)}>{content.email}</p>
                    </div>
                    <img src={Qr} className='w-[25px]' alt="QR CODE" />
                    <div className='flex absolute bottom-[6px] right-4 gap-[2.8px] items-end'>
                        <h1 className='text-[4.5px] text-[#3a3a3a] font-lato'>In Partnership with</h1>
                        <img src={Lm} className=' w-[20.8px] h-[20.8px]' alt="Loan Market" />
                    </div>
                </div>
            </div>
        </div>
