        ...
        <div className='w-[226px] h-[452px] bg-[#fff] dark:bg-[#f4f4f4]'>
            ...
            <div className='flex justify-between items-baseline'>
                ...
                <div className='font-lato pr-3 space-y-[2.18px] text-[#3a3a3a]'>
                    ...
                    <h1 className='text-[5.642px] font-bold' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('name', e)}>{content.name}</h1>
                    <div className='flex items-center gap-[3.6px]'>
                        <BiSolidPhoneCall className='w-[8px] h-[7.2px]' />
                        <p className='text-[5.5px] font-inter' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('phone', e)}>{content.phone}</p>
                    </div>
                    <div className='flex items-center gap-[3.6px]'>
                        <RiWhatsappFill className='w-[8px] h-[7.2px]' />
                        <p className='text-[5.5px] font-inter' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('wa', e)}>{content.wa}</p>
                    </div>
                    <div className='flex items-center gap-[3.6px]'>
                        <IoMdMail className='w-[8px] h-[7.2px]' />
                        <p className='text-[5.5px] font-inter' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('email', e)}>{content.email}</p>
                    </div>
