    ...
    return (
        <div className='w-[600px] h-[398px] flex bg-[#f4f4f4]' >
            ...
            <div className='px-7 mt-4'>
                ...
                <img src={Qr} alt="QR Code" className='absolute w-14 right-7 bottom-16' />
                <div className='absolute flex items-end right-7 bottom-3 gap-1'>
                    <h1 className='text-[7px]'>In Partnership with</h1>
                    <img src={Lm} className=' w-8 ' alt="QR Code" />
                </div>
            </div>
        </div>
    )
