        ...
        <div className='w-[411px] h-[513px] bg-[#f4f4f4]'>
            ...
            <div className='px-3'>
                ...
                <div className='flex justify-between'>
                    ...
                    <div>
                        <div className='font-lato text-[12.8px] mt-3 space-y-[6.18px] text-[#3a3a3a]'>
                            ...
                            <div className='flex gap-2 items-baseline pt-2'>
                                <h1 className='font-lato text-[9.4px]'>In Partnership with</h1>
                                <img src={Lm} className='w-[36px] ' alt="" />
                            </div>
                        </div>
                    </div>
                </div>
