...
import Lm from '../../../assets/images/lm-text.png'
const Signboard3qrlm = (props) => {
        ...
        <div className='w-[411px] h-[513px] bg-[#fff] dark:bg-[#f4f4f4]'>
            <div className='flex justify-between'>
                ...
                <div>
                    <img src={Rw} alt="" />
                    <div
                        className='w-[143px] bg-slate-100 h-[132px] mt-[5.6px] bg-cover bg-center bg-no-repeat relative'
            ...
            <div className='px-3'>
                <div className='font-inter justify-end mt-[15px] px-3 text-[9px] flex gap-4 text-[#3a3a3a] font-bold'>
                ...
                <div className='border-b-2 border-[#8f8f8f] px-3 mt-[17.4px]'></div>
                <div className='flex justify-between'>
                    <div>
                        <div>
                            <ul className='list-disc space-y-[1px] mt-[14px] text-[#3a3a3a] text-[9px] font-light font-lato leading-[140%]'>
                            ...
                            <div className='font-lato mt-6 space-y-[5px] text-[#3a3a3a]'>
                                <h1 className='font-bold text-[9px]'>Property tour schedule</h1>
                                <h2 className='font-light leading-[140%] text-[8px]' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('schedule1', e)}>{content.schedule1}</h2>
                                <h2 className='font-light leading-[140%] text-[8px]' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('schedule2', e)}>{content.schedule2}</h2>
                            </div>
                            <h1 className='font-lato text-[11px] mt-[7px] text-[#3a3a3a] font-bold' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('website', e)}>{content.website}</h1>
                        </div>
                    </div>
                    <div className='py-2'>
                        <div className='font-lato text-[12.8px] space-y-[6.18px] text-[#3a3a3a]'>
                            <h1 className='font-normal text-[8px]'>Agent Contact</h1>
                            <h1 className='font-bold text-[10.8px]' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('name', e)}>{content.name}</h1>
                            <div className='flex items-center gap-[6.6px]'>
                                <BiSolidPhoneCall className='w-[10px] h-[10.2px]' />
                                <p className='font-inter text-[8.8px]' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('phone', e)}>{content.phone}</p>
                            </div>
                            <div className='flex items-center gap-[6.6px]'>
                                <RiWhatsappFill className='w-[10px] h-[10.2px]' />
                                <p className='font-inter text-[8.8px]' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('wa', e)}>{content.wa}</p>
                            </div>
                            <div className='flex items-center gap-[6.6px]'>
                                <IoMdMail className='w-[10px] h-[10.2px]' />
                                <p className='text-[8.8px] font-inter' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('email', e)}>{content.email}</p>
                            </div>
                            <img src={Qr} className='w-[40px] h-[40px]' alt="" />
                            <div className='flex items-center'>
                                <h1 className='text-[6.3px]'>In Partnership with</h1>
                                <img src={Lm} className='h-[13px]' alt="" />
                            </div>
                        </div>
                    </div>
                </div>
