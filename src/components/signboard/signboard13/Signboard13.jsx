...
const Signboard13 = () => {
    ...
    const defaultUser = async () => {
        try {
            const response = await axios.get(
                "https://brandcentralapi.raywhite.co.id/signboard2/create",
                {
                    headers: {
    ...
    const saveDataToAPI = async () => {
        try {
            ...
            const response = await axios.post(
                "https://brandcentralapi.raywhite.co.id/signboard2/save",
                dataToBeSaved,
                {
                    headers: {
    ...
    return (
        <div className="flex flex-col justify-center items-end">
            <div
                className={`${imageColor === "yellow" ? "bg-primary-color" : "bg-[#fff]"
                    } w-[384px] h-[512px] flex flex-col items-center justify-center relative`}
            >
                <img
                ...
                <div className="px-8 mt-24 py-28 font-lato text-[#3a3a3a] text-center relative">
                    ...
                    <h1
                        className="text-[54px] font-playfair font-bold cursor-pointer"
                    ...
                    <p
                        className="text-[30px] font-bold font-lato cursor-pointer"
                    ...
                    <p className="text-[15px] font-lato font-bold mt-4">
                        {content.officeName || "Ray White Indonesia"}
                    </p>
                    <p className="text-[15px] font-lato font-bold">
