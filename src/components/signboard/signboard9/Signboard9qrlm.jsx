    ...
    return (
        <div className='w-[350px] h-[526px] bg-[#f4f4f4]'>
            <div className='flex gap-[1.7px]'>
                <div>
                    <div
                        className='w-[245px] bg-slate-100 h-[234px] bg-cover bg-center bg-no-repeat relative'
                    ...
                    <div className='flex mt-[2.3px] gap-[2px]'>
                        <div
                            className='w-[121px] bg-slate-100 h-[88px] bg-cover bg-center bg-no-repeat relative'
                ...
                <div>
                    <img src={Rw} className='w-[103.8px] h-[97.7px]' alt="RayWhite" />
                    <div
                        className='w-[103px] mt-[2px] bg-slate-100 h-[224px] bg-cover bg-center bg-no-repeat relative'
            ...
            <div className='flex px-3 justify-between items-baseline'>
                <div className='mt-[12.5px] px-2'>
                    ...
                    <div className='font-lato mt-3 space-y-[1.2px] text-[#3a3a3a] text-[7px]'>
                        <h1 className='font-bold text-[8px] '>Property tour schedule</h1>
                ...
                <div className='flex gap-[15px]'>
                    <div className='font-lato space-y-[7.18px] text-[#3a3a3a]'>
                    ...
                    <img src={Qr} className='w-[45px] h-[45px]' alt="QR Code" />
                </div>
                <div className='flex items-end absolute right-3 bottom-6 gap-2'>
