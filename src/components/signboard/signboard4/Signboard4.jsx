        ...
        <div className='w-[583px] h-[466px] bg-[#fff] dark:bg-[#f4f4f4]'>
            <div className='flex gap-8 items-center'>
                ...
                <div className='w-[200px]'>
                    ...
                    <div className='font-lato text-[12.8px] mt-[22px] space-y-[4.18px] text-[#3a3a3a]'>
                        ...
                        <h1 className='font-lato text-[12px] pt-[54px] text-[#3a3a3a] font-bold' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('website', e)}>{content.website}</h1>
                    </div>
                </div>
            </div>
