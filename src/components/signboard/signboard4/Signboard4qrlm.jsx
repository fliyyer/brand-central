...
import Sb2 from '../../../assets/images/instagram/ig4.jpeg';
        ...
        <div className='w-[583px] h-[466px] bg-[#fff] dark:bg-[#f4f4f4]'>
            <div className='flex gap-8 items-center'>
                <div>
                    <div className='flex gap-[3px]'>
                        <div className='flex gap-[1px]'>
                            <img src={Rw} className='w-[107px] h-[107px]' alt="" />
                            <div
                                className='w-[221px] bg-slate-100 h-[107px] bg-cover bg-center bg-no-repeat relative'
                    ...
                    <div className='flex gap-[2px]'>
                        <div
                            className='w-[330px] bg-slate-100 h-[357px] mt-[2px] bg-cover bg-center bg-no-repeat relative'
                ...
                <div className='w-[200px]'>
                    <div className='border-b-2 border-[#3a3a3a] mb-[11.4px]'></div>
                    <div className='font-inter justify-end mt-[10px] text-[10px] flex gap-4 text-[#3a3a3a] font-bold'>
                    ...
                    <div className='font-lato text-[8.8px] mt-[22px] space-y-[4.18px] text-[#3a3a3a]'>
                        <h1 className='font-normal'>Agent Contact</h1>
                        <h1 className='font-bold text-[10px]' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('name', e)}>{content.name}</h1>
                        ...
                        <img src={Qr} className='pt-[11px] pb-4' alt="Qr code" />
                        <div className='flex items-end'>
                            <h1 className='font-lato text-[8.8spx]'>In Partnership with</h1>
                            <img src={Lm} className='h-[18px]' alt="" />
                        </div>
                    </div>
                </div>
            </div>
