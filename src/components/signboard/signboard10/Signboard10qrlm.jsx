    ...
    return (
        <div className='w-[738px] flex gap-[2px] h-[492px] bg-[#fff] dark:bg-[#f4f4f4]'>
            ...
            <div className='px-[21px]'>
                <div className='border-b-2 border-[#8f8f8f] w-[205px] mt-[25.4px]'></div>
                ...
                <div className='mt-[12.5px]'>
                    ...
                    <div className='font-lato mt-4 space-y-[5px] text-[#3a3a3a]'>
                ...
                <div className='font-lato text-[10.8px] mt-[22px] space-y-[12.18px] text-[#3a3a3a]'>
                    ...
                    <div className='flex absolute bottom-7 right-3 gap-2 items-end'>
                        <h1 className='font-lato text-[8px]'>In Partnership with</h1>
                        <img src={Lm} alt="Loan Market" className='w-[39px] h-[39px]' />
                    </div>
                </div>
            </div>
        </div>
...
export default Signboard10qrlm
