    ...
    return (
        <div className='w-[738px] flex gap-[2px] h-[492px] bg-[#fff] dark:bg-[#f4f4f4]'>
            <div>
                <div className='flex'>
                    <div>
                        <img src={Rw} className='w-[145.7px] h-[137px]' alt="Raywhite" />
                        <div
                            className='w-[145px] bg-slate-100 mt-[2px] h-[182.6px] bg-cover bg-center bg-no-repeat relative'
                    ...
                    <div>
                        <div
                            className='w-[343.7px] h-[322.2px] bg-cover bg-center bg-no-repeat relative'
                ...
                <div className='flex mt-[2.4px] gap-[2px]'>
                    <div
                        className='w-[244px] bg-slate-100 h-[167px] bg-cover bg-center bg-no-repeat relative'
            ...
            <div className='px-[21px]'>
                <div className='border-b-2 border-[#8f8f8f] w-[205px] mt-[55.4px]'></div>
                ...
                <div className='font-lato text-[10.8px] mt-[22px] space-y-[12.18px] text-[#3a3a3a]'>
                    ...
                    <h1 className='font-lato text-[12px] pt-[30px] text-[#3a3a3a] font-bold' contentEditable={true} suppressContentEditableWarning={true} onBlur={(e) => handleEditAndSave('website', e)}>{content.website}</h1>
                </div>
            </div>
        </div>
    )
