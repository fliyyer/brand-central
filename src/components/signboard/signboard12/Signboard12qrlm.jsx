...
const Signboard12qrlm = (props) => {
    ...
    return (
        <div className='w-[750px] h-[531px] bg-[#fff] py-[7.43px] px-2'>
            ...
            <img src={Qr} className='w-[80px] h-[80px] absolute left-6 bottom-28' alt="QR Code" />
            <div className='flex items-end absolute right-3 bottom-28 bg-[#fff] p-[10px] gap-2'>
...
export default Signboard12qrlm
