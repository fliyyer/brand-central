...
const EmailSignature1 = () => {
    ...
    return (
        <div className='w-[735px] h-[238px] p-[15.4px] bg-[#fff]'>
            <div className='flex justify-between items-center'>
                <div>
                    <h1 className='text-[#5C5C5C] mt-8 text-[27px] font-bold' contentEditable={true} onBlur={(e) => handleEditAndSave('name', e)} suppressContentEditableWarning={true}>{content.name}</h1>
                    <h1 className='text-[#5C5C5C] text-[21.7px] font-extralight' contentEditable={true} onBlur={(e) => handleEditAndSave('position', e)} suppressContentEditableWarning={true}>{content.position}</h1>
                </div>
