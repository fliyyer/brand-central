                ...
                <div>
                    ...
                    >
                        <ul className="items-center font-roboto justify-center space-y-8 md:flex md:space-x-2 md:space-y-0">
                            ...
                            {openProfileDropdown && (
                                <div style={responsiveDropdownStyle}>
                                    <ul className="uppercase font-sans text-sm leading-5">
                                        <li className="py-3 px-4 flex items-center gap-2 hover:bg-dropdown-hover hover:ease-out hover:duration-300 cursor-pointer">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
