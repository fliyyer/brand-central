...
const Banner4x1foto = () => {
    ...
    const defaultUser = async () => {
        try {
            const response = await axios.get(
                "https://brandcentralapi.raywhite.co.id/banner10/create",
                {
                    headers: {
    ...
    const saveDataToAPI = async () => {
        try {
            ...
            const response = await axios.post(
                "https://brandcentralapi.raywhite.co.id/banner10/save",
                dataToBeSaved,
                {
                    headers: {
    ...
    return (
        <div className="flex flex-col justify-center items-end">
            <div
                className={`w-[1048px] font-lato h-[262px] ${imageColor === "yellow" ? "bg-primary-color" : "bg-[#fff]"
                    } relative`}
            >
                <img
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                ...
                                <p
                                    ...
                                    className="text-[29px] uppercase font-bold cursor-pointer"
                                >
                                    {content.agentName}
                                </p>
                                {isMobileEditing && (
                                ...
                                <p
                                    ...
                                    className="text-[29px] cursor-pointer font-bold"
                                >
                            ...
                            <p className="flex items-center gap-2 text-[30px] font-bold">
                                <img src={Call} className="w-7 mt-1" />
                                <span>{content.agentOfficePhone}</span>
                            </p>
                        </div>
                    </div>
                    <div className="flex absolute right-12 bottom-2">
                        <div>
