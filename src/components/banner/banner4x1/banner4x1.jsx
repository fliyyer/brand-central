    ...
    const defaultUser = async () => {
        try {
            const response = await axios.get(
                "https://brandcentralapi.raywhite.co.id/banner9/create",
                {
                    headers: {
    ...
    const saveDataToAPI = async () => {
        try {
            ...
            const response = await axios.post(
                "https://brandcentralapi.raywhite.co.id/banner9/save",
                dataToBeSaved,
                {
                    headers: {
            ...
            >
                ...
                <div className="px-12 py-0 text-[#3a3a3a] relative">
                    ...
                    <div className="flex gap-3">
                        ...
                        <p
                            className="text-[29px] font-bold uppercase cursor-pointer"
