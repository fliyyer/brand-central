...
const Banner200x100foto = () => {
    ...
    const defaultUser = async () => {
        try {
            const response = await axios.get(
                "https://brandcentralapi.raywhite.co.id/banner6/create",
                {
                    headers: {
    ...
    const saveDataToAPI = async () => {
        try {
            ...
            const response = await axios.post(
                "https://brandcentralapi.raywhite.co.id/banner6/save",
                dataToBeSaved,
                {
                    headers: {
    ...
    return (
        <div className="flex flex-col justify-center items-end">
            <div
                className={`w-[769px] font-lato text-[#3a3a3a] h-[381px] ${imageColor === "yellow" ? "bg-primary-color text-[#3a3a3a]" : "bg-[#fff] text-[#595A5C]"} relative`}
            >
                <img
                ...
                <div className="px-12 py-16 relative">
                    ...
                    <div className="flex pt-4 gap-5">
                        ...
                        <div>
                            ...
                            <p onClick={handleNameEdit} className="text-[29px] uppercase cursor-pointer font-bold">{content.agentName}</p>
                            {isMobileEditing && (
                                <TextEditorPopup
                            ...
                            <p onClick={handleMobileEdit} className="text-[29px] cursor-pointer font-bold">
                                {content.agentPhone || "0812 1234 5678"}
                            </p>
                            <p className="flex items-center gap-2 text-[30px] font-bold">
                                <img className="w-6" src={Call} alt="Phone" />
