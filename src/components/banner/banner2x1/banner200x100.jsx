...
const Banner200x100 = () => {
    ...
    const defaultUser = async () => {
        try {
            const response = await axios.get(
                "https://brandcentralapi.raywhite.co.id/banner5/create",
                {
                    headers: {
    ...
    const saveDataToAPI = async () => {
        try {
            ...
            const response = await axios.post(
                "https://brandcentralapi.raywhite.co.id/banner5/save",
                dataToBeSaved,
                {
                    headers: {
    ...
    return (
        <div className="flex flex-col items-end justify-center">
            <div className={`w-[769px] font-lato h-[381px] ${imageColor === "yellow" ? "bg-primary-color text-[#3a3a3a]" : "bg-[#fff] text-[#595A5C]"} relative`}>
                <img
                ...
                <div className="px-12 py-16 relative">
                    ...
                    <h1
                        className="text-[30px] uppercase font-lato font-bold cursor-pointer"
