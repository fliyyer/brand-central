...
import Flyer1 from '../../components/flyer/Flyer1';
    ...
    return (
        <div className='min-h-screen'>
            ...
            <div className='dark:bg-bg-content bg-[#f2f2f2]  px-6 lg:px-28 py-7 w-full min-h-screen flex flex-col justify-start items-center'>
                ...
                <div className='my-16 md:my-36' style={zoomStyle}>
                    <Flyer1 onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />
                </div>
