...
import Signboard2 from '../../components/signboard/signboard2/Signboard2';
import PopImg from '../../components/pop-up/PopImg';
import { listingImages } from '../../utils/ListingImg';
import Signboard2qr from '../../components/signboard/signboard2/Signboard2qr';
import Signboard2lm from '../../components/signboard/signboard2/Signboard2lm';
import Signboard2qrlm from '../../components/signboard/signboard2/Signboard2.qrlm';

const SignBoardEdit2 = () => {
    ...
    const renderSelectedComponent = () => {
        switch (selectedComponent) {
            case 'Sign Board text only':
                return <Signboard2 onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr':
                return <Signboard2qr onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board with Loan Market':
                return <Signboard2lm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr with Loan Market':
                return <Signboard2qrlm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
        }
    };
