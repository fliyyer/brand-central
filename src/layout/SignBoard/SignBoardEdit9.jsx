...
import Signboard9 from '../../components/signboard/signboard9/Signboard9';
import Signboard9qr from '../../components/signboard/signboard9/Signboard9qr';
import Signboard9lm from '../../components/signboard/signboard9/Signboard9lm';
import Signboard9qrlm from '../../components/signboard/signboard9/Signboard9qrlm';

const SignBoardEdit9 = () => {
    ...
    const renderSelectedComponent = () => {
        switch (selectedComponent) {
            case 'Sign Board text only':
                return <Signboard9 onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr':
                return <Signboard9qr onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board with Loan Market':
                return <Signboard9lm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr with Loan Market':
                return <Signboard9qrlm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
        }
    };
