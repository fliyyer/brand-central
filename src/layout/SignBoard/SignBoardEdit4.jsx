...
import Signboard4 from '../../components/signboard/signboard4/Signboard4';
import Signboard4qr from '../../components/signboard/signboard4/Signboard4qr';
import Signboard4lm from '../../components/signboard/signboard4/Signboard4lm';
import Signboard4qrlm from '../../components/signboard/signboard4/Signboard4qrlm';

const SignBoardEdit4 = () => {
    ...
    const renderSelectedComponent = () => {
        switch (selectedComponent) {
            case 'Sign Board text only':
                return <Signboard4 onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr':
                return <Signboard4qr onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board with Loan Market':
                return <Signboard4lm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr with Loan Market':
                return <Signboard4qrlm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
        }
    };
