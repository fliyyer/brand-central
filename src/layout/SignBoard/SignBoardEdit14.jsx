...
import Signboard14 from '../../components/signboard/signboard14/Signboard14';
import Signboard14qr from '../../components/signboard/signboard14/Signboard14qr';
import Signboard14lm from '../../components/signboard/signboard14/Signboard14lm';

const SignBoardEdit14 = () => {
    ...
    const renderSelectedComponent = () => {
        switch (selectedComponent) {
            case 'Sign Board text only':
                return <Signboard14 onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr':
                return <Signboard14qr onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board with Loan Market':
                return <Signboard14lm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
        }
    };
...
export default SignBoardEdit14;
