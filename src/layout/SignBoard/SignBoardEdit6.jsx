...
import Signboard6 from '../../components/signboard/signboard6/Signboard6';
import Signboard6qr from '../../components/signboard/signboard6/Signboard6qr';
import Signboard6lm from '../../components/signboard/signboard6/Signboard6lm';
import Signboard6qrlm from '../../components/signboard/signboard6/Signboard6qrlm';

const SignBoardEdit6 = () => {
    ...
    const renderSelectedComponent = () => {
        switch (selectedComponent) {
            case 'Sign Board text only':
                return <Signboard6 onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr':
                return <Signboard6qr onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board with Loan Market':
                return <Signboard6lm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr with Loan Market':
                return <Signboard6qrlm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
        }
    };
