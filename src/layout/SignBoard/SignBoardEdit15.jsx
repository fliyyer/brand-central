...
import Signboard15 from '../../components/signboard/signboard15/Signboard15';
import Signboard15qr from '../../components/signboard/signboard15/Signboard15qr';
import Signboard15lm from '../../components/signboard/signboard15/Signboard15lm';

const SignBoardEdit15 = () => {
    ...
    const renderSelectedComponent = () => {
        switch (selectedComponent) {
            case 'Sign Board text only':
                return <Signboard15 onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr':
                return <Signboard15qr onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board with Loan Market':
                return <Signboard15lm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
        }
    };
...
export default SignBoardEdit15;
