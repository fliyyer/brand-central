...
import Signboard7 from '../../components/signboard/signboard7/Signboard7';
import Signboard7qr from '../../components/signboard/signboard7/Signboard7qr';
import Signboard7lm from '../../components/signboard/signboard7/Signboard7lm';
import Signboard7qrlm from '../../components/signboard/signboard7/Signboard7qrlm';

const SignBoardEdit7 = () => {
    ...
    const renderSelectedComponent = () => {
        switch (selectedComponent) {
            case 'Sign Board text only':
                return <Signboard7 onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr':
                return <Signboard7qr onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board with Loan Market':
                return <Signboard7lm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr with Loan Market':
                return <Signboard7qrlm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
        }
    };
    ...
    return (
        <div className='min-h-screen'>
            ...
            <div className='bg-dark  px-6 lg:px-28 py-7 w-full min-h-screen flex flex-col justify-start items-center'>
                ...
                <div className='my-12 md:my-16' style={zoomStyle}>
                    <select
