...
import Signboard16 from '../../components/signboard/signboard16/Signboard16';
import Signboard16qr from '../../components/signboard/signboard16/SignBoard16qr';
import Signboard16lm from '../../components/signboard/signboard16/SignBoard16lm';

const SignBoardEdit16 = () => {
    ...
    const renderSelectedComponent = () => {
        switch (selectedComponent) {
            case 'Sign Board text only':
                return <Signboard16 onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr':
                return <Signboard16qr onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board with Loan Market':
                return <Signboard16lm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
        }
    };
...
export default SignBoardEdit16;
