...
import Signboard13 from '../../components/signboard/signboard13/Signboard13';
import Signboard13qr from '../../components/signboard/signboard13/Signboard13qr';
import Signboard13lm from '../../components/signboard/signboard13/Signboard13lm';

const SignBoardEdit13 = () => {
    ...
    const renderSelectedComponent = () => {
        switch (selectedComponent) {
            case 'Sign Board text only':
                return <Signboard13 onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr':
                return <Signboard13qr onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board with Loan Market':
                return <Signboard13lm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
        }
    };
...
export default SignBoardEdit13;
