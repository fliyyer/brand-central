...
import Signboard12 from '../../components/signboard/signboard12/Signboard12';
import Signboard12qr from '../../components/signboard/signboard12/Signboard12qr';
import Signboard12lm from '../../components/signboard/signboard12/Signboard12lm';
import Signboard12qrlm from '../../components/signboard/signboard12/Signboard12qrlm';

const SignBoardEdit12 = () => {
    ...
    const renderSelectedComponent = () => {
        switch (selectedComponent) {
            case 'Sign Board text only':
                return <Signboard12 onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr':
                return <Signboard12qr onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board with Loan Market':
                return <Signboard12lm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr with Loan Market':
                return <Signboard12qrlm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
        }
    };
    ...
    return (
        <div className='min-h-screen'>
            ...
            <div className='dark:bg-bg-content bg-[#f2f2f2]  px-6 lg:px-28 py-7 w-full min-h-screen flex flex-col justify-start items-center'>
                ...
                <div className='mt-4 md:my-16' style={zoomStyle}>
                    <select
...
export default SignBoardEdit12;
