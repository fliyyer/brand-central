...
import Signboard11 from '../../components/signboard/signboard11/Signboard11';
import Signboard11qr from '../../components/signboard/signboard11/Signboard11qr';
import Signboard11lm from '../../components/signboard/signboard11/Signboard11lm';
import Signboard11qrlm from '../../components/signboard/signboard11/Signboard11qrlm';

const SignBoardEdit11 = () => {
    ...
    const renderSelectedComponent = () => {
        switch (selectedComponent) {
            case 'Sign Board text only':
                return <Signboard11 onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr':
                return <Signboard11qr onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board with Loan Market':
                return <Signboard11lm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
            case 'Sign Board Qr with Loan Market':
                return <Signboard11qrlm onClick={openPopImg} bgImage={bgImage} setBgImage={setBgImage} />;
        }
    };
...
export default SignBoardEdit11;
