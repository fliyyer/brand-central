...
import Banner300x100 from '../../components/banner/banner3x1/banner300x100';
import Banner300x100foto from '../../components/banner/banner3x1/banner300x100foto';
import Banner300x100qr from '../../components/banner/banner3x1/banner300x100qr';
import Banner300x100lm from '../../components/banner/banner3x1/banner300x100lm';
import Banner300x100qrlm from '../../components/banner/banner3x1/banner300x100qrlm';

const BannerEdit3x1 = () => {
    const [selectedComponent, setSelectedComponent] = useState('Banner300x100');
    ...
    const renderSelectedComponent = () => {
        switch (selectedComponent) {
            case 'Banner300x100':
                return <Banner300x100 />;
            case 'Banner300x100foto':
                return <Banner300x100foto />;
            case 'Banner300x100qr':
                return <Banner300x100qr />;
            case 'Banner300x100lm':
                return <Banner300x100lm />;
            case 'Banner300x100qrlm':
                return <Banner300x100qrlm />;
            default:
                return null;
        }
    };
        ...
        <div className='min-h-screen'>
            ...
            <div className='bg-dark  px-6 lg:px-28 py-7 w-full min-h-screen flex flex-col justify-start items-center'>
                ...
                <div className='my-auto ' style={zoomStyle}>
                    ...
                    >
                        <option value="Banner300x100" className='bg-text-board-color'>Banner text only</option>
                        <option value="Banner300x100foto" className='bg-text-board-color rounded-none'>Banner with Photo</option>
                        <option value="Banner300x100qr" className='bg-text-board-color rounded-none'>Banner with QR</option>
                        <option value="Banner300x100lm" className='bg-text-board-color rounded-none'>Banner with Loan Market</option>
                        <option value="Banner300x100qrlm" className='bg-text-board-color rounded-none'>Banner QR with Loan Market</option>
                    </select>
