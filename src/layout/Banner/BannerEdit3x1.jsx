            ...
            <div className='dark:bg-bg-content bg-cover bg-no-repeat bg-[#f2f2f2]  px-6 lg:px-28 py-7 w-full min-h-screen flex flex-col justify-start items-center'>
                ...
                <div className='my-auto ' style={zoomStyle}>
                    ...
                    >
                        ...
                        <option value="Banner300x100qr" className='bg-[#fff] dark:bg-text-board-color rounded-none'>Banner with QR</option>
                        <option value="Banner300x100lm" className='bg-[#fff] dark:bg-text-board-color rounded-none'>Banner with Loan Market</option>
                        <option value="Banner300x100qrlm" className='bg-[#fff] dark:bg-text-board-color rounded-none'>Banner QR with Loan Market</option>
                    </select>
