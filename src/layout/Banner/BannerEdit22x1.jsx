...
const BannerEdit22x1 = () => {
    ...
    return (
        <div className='min-h-screen'>
            ...
            <div className='dark:bg-bg-content bg-cover bg-no-repeat bg-[#f2f2f2] lg:px-28 py-7 w-full min-h-screen flex flex-col justify-start items-center'>
                <Link to='/'>
                ...
                <div className='my-16'>
                    <select
                        ...
                        className="py-2 mb-2 ml-32 md:ml-0 text-sm font-medium bg-transparent leading-[20px] text-[#5c5c5c] dark:text-[#fff] border-none md:w-full lg:w-auto"
                    >
                        <option value="Banner22x1" className='bg-[#fff] dark:bg-text-board-color'>Banner text only</option>
                        <option value="Banner22x1lm" className='bg-[#fff] dark:bg-text-board-color rounded-none'>Banner with Loan Mrket</option>
                    </select>
