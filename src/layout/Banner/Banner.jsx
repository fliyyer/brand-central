        ...
        <>
            <div className="flex flex-col items-center justify-center py-12 gap-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 justify-center items-center">
                    <CardBanner title='Banner 1 x 1' img={Banner_1x1} />
                    <CardBanner title='Banner 2 x 1' img={Banner_2x1} />
                    <CardBanner title='Banner 3 x 1' img={Banner_3x1} />
                    <CardBanner title='Banner 4 x 1' img={Banner_4x1} />
                    <CardBanner title='Banner 2 name 2 x 1' img={Banner_name2x1} />
                    <CardBanner title='X Banner 60 x 160' img={Banner_x6x1} />
                </div>
            </div>
            <Footer />
        </>
