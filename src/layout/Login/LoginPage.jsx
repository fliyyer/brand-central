    ...
    return (
        ...
        >
            ...
            <div className="p-2 md:px-4 mt-[46px] rounded font-poppins w-full md:w-1/2 lg:w-1/3 xl:w-1/4">
                <img
                    src={brandCentralImage}
                    alt="Logo Brand Central"
                    className="mx-auto md:mt-[46px] mb-4"
                />
                <div
                    className={`text-2xl md:text-3xl lg:text-4xl xl:text-[51.5px] dark:text-[#fff]  text-[#5C5C5C] text-center`}
                >
                    <div className="leading-[110%]">
                        Build your
                        <span className="font-bold leading-[139%]">
                            {" "}
