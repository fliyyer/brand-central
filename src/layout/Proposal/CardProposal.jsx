...
const CardProposal = (props) => {
    ...
    return (
        <div className='w-[300px] h-[442px] bg-[#fff] p-5 rounded-[20px] flex flex-col justify-center items-center border-1 border-[#F2F2F2]'>
            ...
            <img className={`my-auto w-auto`} src={img} alt="Envelope" />
